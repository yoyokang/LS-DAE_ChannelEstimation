...
function [Xtraining_Cell, Xtraining_Array, Ytraining_regression_array, Xvalidation_regression, Yvalidation_regression] =Link6_data_Generation(Training_set_ratio, SNRrange, Num_of_frame)
...
cfgLayout.ScenarioVector = [14];     % 6 for B4, 11 for C2 and 13 for C4
...
cfgLayout.Stations(2).Pos(1:2) = [2000; 8000];
